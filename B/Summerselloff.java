...
public class Summerselloff {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            arr[i][0] = Math.min(2*products[i][0], products[i][1]) - Math.min(products[i][0], products[i][1]);
            arr[i][1] = i;
        }
        ...
        for (int i = 0; i < f; i++) {
            int pos = arr[i][1];
            ans+= Math.min(2* products[pos][0], products[pos][1]);
        }
        for (int i = f; i < n; i++) {
            int pos = arr[i][1];
            ans+= Math.min(products[pos][0], products[pos][1]);
        }
