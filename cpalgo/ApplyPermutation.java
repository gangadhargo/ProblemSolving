...
public class ApplyPermutation {
    ...
    public static List<Integer> applyPermutation(List<Integer> sequence){
        List<Integer> newPermutation = new LinkedList<>();
        for(int i=0; i<sequence.size(); i++){
            newPermutation.add(i, sequence.get(i));
        }
    ...
    public static void main(String[] args) {
        ...
        while(b > 0){
            if(b % 2 == 1){
                sequence = applyPermutation(sequence);
            }
