...
public class Locker {
    public static long modulo(long a, long b, long mod) {
        a = a%mod;
        long ans = 1;
        while (b > 0) {
            if (b % 2 == 1) {
    ...
    public static void main(String[] args) {
        ...
        long mod = 1000000007;
        if(a < 3){
            System.out.println(modulo(3, a/3, mod) % mod);
        }else if(a%3 == 1) {
            a -= 4;
            System.out.println(4 * modulo(3, a / 3, mod) % mod);
        }else{
            a-=2;
            System.out.println(2 * modulo(3, a/3, mod) % mod);
        }
