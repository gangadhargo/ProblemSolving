...
public class PermutationTransformation {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < t; i++) {
            ...
            int[] d = new int[n];
            permuteTransformation(a, 0, n-1, d, 0);
            for(int k=0; k<n; k++){
    ...
    public static void permuteTransformation(int[] a, int l, int r, int[] d, int curr){
        if(l > r){
            return;
        }
        if(l == r){
        ...
        d[m] = curr;
        permuteTransformation(a, l, m-1, d, curr+1);
        permuteTransformation(a, m+1, r, d, curr+1);
    }
